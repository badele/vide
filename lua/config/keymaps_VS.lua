...
-- Searc on current bufferh
map({ "i" }, "<C-f>", '<esc>/', { desc = "Search (VS)" })
map({ "v", "n", "s" }, "<C-f>", '/', { desc = "Search (VS)" })

-- Searc on files
map({ "i" }, "<C-S-f>", '<esc><cmd>Telescope live_grep<CR>', { desc = "Search files (VS)", remap = true })
map({ "v", "n", "s" }, "<C-S-f>", '<cmd>Telescope live_grep<CR>', { desc = "Search files (VS)", remap = true })
